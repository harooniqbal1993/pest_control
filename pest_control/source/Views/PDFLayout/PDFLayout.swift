...
class PDFLayout: UIView {
    ...
    func fillData() {
        ...
        childrenCheckbox.image = (outputData.assessmentData?.children ?? false) ? UIImage(resource: .checkboxChecked) : UIImage(resource: .checkboxUnchecked)
        employeesCheckbox.image = (outputData.assessmentData?.employees ?? false) ? UIImage(resource: .checkboxChecked) : UIImage(resource: .checkboxUnchecked)
        publicCheckbox.image = (outputData.assessmentData?.publicCheck ?? false) ? UIImage(resource: .checkboxChecked) : UIImage(resource: .checkboxUnchecked)
        petAnimalsCheckbox.image = (outputData.assessmentData?.petAnimals ?? false) ? UIImage(resource: .checkboxChecked) : UIImage(resource: .checkboxUnchecked)
        protectedWilfLifeCheckbox.image = (outputData.assessmentData?.protectedWildLife ?? false) ? UIImage(resource: .checkboxChecked) : UIImage(resource: .checkboxUnchecked)
        openFoodCheckbox.image = (outputData.assessmentData?.openFood ?? false) ? UIImage(resource: .checkboxChecked) : UIImage(resource: .checkboxUnchecked)
        bodiesCheckbox.image = (outputData.assessmentData?.bodies ?? false) ? UIImage(resource: .checkboxChecked) : UIImage(resource: .checkboxUnchecked)
        droppingsCheckbox.image = (outputData.assessmentData?.droppings ?? false) ? UIImage(resource: .checkboxChecked) : UIImage(resource: .checkboxUnchecked)
        gnawingCheckbox.image = (outputData.assessmentData?.gnawing ?? false) ? UIImage(resource: .checkboxChecked) : UIImage(resource: .checkboxUnchecked)
        smearCheckbox.image = (outputData.assessmentData?.smear ?? false) ? UIImage(resource: .checkboxChecked) : UIImage(resource: .checkboxUnchecked)
        groundWholeCheckbox.image = (outputData.assessmentData?.groundHole ?? false) ? UIImage(resource: .checkboxChecked) : UIImage(resource: .checkboxUnchecked)
        sightingCheckbox.image = (outputData.assessmentData?.sighting ?? false) ? UIImage(resource: .checkboxChecked) : UIImage(resource: .checkboxUnchecked)
